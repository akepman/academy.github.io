function addSaveAsPdfButton() {
	...
	var saveAsPdfButton = new Terrasoft.Button({id:'saveAsPdfButton', menuConfig:[
		{id:"PageContainer_MenuItem2",xtype:"menuitem",caption:"Руководство", handler: function () { openPdfFile('BPMonline_base_UG.pdf');}}],
	...
	saveAsPdfButton.on('click', function(){ openPdfFile('BPMonline_base_UG.pdf');}, saveAsPdfButton);
}
